...
import wandb
from encoder import UrbanSoundTransformerEncoder as Encoder

wandb.init(project="UrbanSound8KEncoder")
...
wandb.save(model.state_dict(), "models/encoder.pth")
print("Model saved to models/encoder.pth")
